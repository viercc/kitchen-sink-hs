...
viewPow (Pow n e) = case viewNat n of
  IsZero -> PowZero
  IsSucc n' -> PowSucc (Pow n' (e . weaken)) (e (withKnownNat n maxBound))

reviewPow :: PowView n f x -> Pow n f x
reviewPow PowZero = Pow sZero absurdFinite
reviewPow (PowSucc (Pow n e) fx) = Pow (sSucc n) (either e (const fx) . withKnownNat n separateSum)
